        ...
        <form method="post">
            <div class="form-group">
                ...
                <select class="form-control" name="kode_aspek">
                    <option></option>
                    <?=get_aspek_option(set_value('kode_aspek', $row->kode_aspek))?>
                </select>
            </div>
            <div class="form-group">
                <label>Kode <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="kode_kriteria" value="<?=set_value('kode_kriteria', $row->kode_kriteria)?>" readonly/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="factor">
                    <option></option>
                    <?=get_factor_option(set_value('factor', $row->factor))?>
                </select>
            </div>
            <div class="form-group">
